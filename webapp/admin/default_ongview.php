...
<body onLoad="loadMap();">
	<div class="wrapper">
		...
		<div class="colIzq">
			...
			<div class="scrollPanel">
				<div class="contactlist">
					<h3><?php print(getLocaleString("Datos del tracking")); ?></h3>
						<?php
						if(isset($datosTracking)){
						?>
						
						<div>
							<h4><?php print(getLocaleString("latitud")); ?></h4>			
							<div><?php	print_r($datosTracking['latitude']); ?></div>
	
							<h4><?php print(getLocaleString("longitud")); ?></h4>			
							<div><?php	print_r($datosTracking['longitude']); ?></div>
							
							<h4><?php print(getLocaleString("Bateria")); ?></h4>			
							<div><?php	print_r($datosTracking['bateria']); ?></div>
							
							<h4><?php print(getLocaleString("contactar a")); ?></h4>			
							<ul>
								<?php 
									$correos = explode(",",$datosTracking['emailsIds']); 
									
									
									while($correo = each($correos)){
										print("<li>".$correo["value"]."</li>");
									}
						...
						<?php
							...
							print(getLocaleString("haga una b&uacute;squeda"));
							?>
							</div>
		...
		<div class="colDer">
			<ul class="navigation">
				<li class="selected">
					<a onClick="changeToSection('busqueda_usuario.php?ajax=true',this)"><span><?php print(getLocaleString("B&uacute;squeda de usuario")); ?></span></a>
				</li>
